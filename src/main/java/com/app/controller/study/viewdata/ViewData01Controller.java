...
public class ViewData01Controller {
	...
	public String viewData1(HttpServletRequest request) {
		...
		//		request.setAttribute(key, value); -> 화면으로 전달할 정보를 request에 담아둠
	...
	public ModelAndView viewData3() {
		...
		ModelAndView mav = new ModelAndView(); //스프링에 있는 객체

		mav.setViewName("viewData/viewData1"); //return처럼 사용!
	...
	public String viewData6(HttpServletRequest request) {
		...
		// .../viewData6?searchKeyword=커피 => 커피라고 치면 커피라고 페이지에 나올 수 있도록 만들기!
...
//	public String viewData7(Model model, HttpServletRequest request) {
